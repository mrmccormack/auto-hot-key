...
AddMenu("AutoFileMenu", "Close All Files", "CloseAllTabs")
Menu AutoFileMenu, Add
...
Menu AutoViewMenu, Add
AddMenu("AutoViewMenu", "&Wrap Long Lines", "ToggleWordWrap")
Menu AutoViewMenu, Add, &Show White Spaces, ToggleWhiteSpaces
Menu AutoViewMenu, Add
AddMenu("AutoViewMenu", "Syntax &Highlighting", "ToggleSyntaxHighlighting")
AddMenu("AutoViewMenu", "Highlight &Active Line", "ToggleHighlightActiveLine")
AddMenu("AutoViewMenu", "Highlight Identical Te&xt", "ToggleHighlightIdenticalText")
Menu AutoViewMenu, Add
...
AddMenu("AutoRunMenu", "Start Debugging`tF5", "DebugRun", IconLib, 104)
AddMenu("AutoRunMenu", "Break`tBreak", "DebugBreak", IconLib, 105)
AddMenu("AutoRunMenu", "Stop Debugging`tF8", "DebugStop", IconLib, 106)
Menu AutoRunMenu, Add
AddMenu("AutoRunMenu", "Attach Debugger...", "ShowAttachDialog", IconLib, 107)
Menu AutoRunMenu, Add
AddMenu("AutoRunMenu", "Step Into`tF6", "StepInto", IconLib, 109)
AddMenu("AutoRunMenu", "Step Over`tF7", "StepOver", IconLib, 110)
AddMenu("AutoRunMenu", "Step Out`tShift+F6", "StepOut", IconLib, 111)
;AddMenu("AutoRunMenu", "Run to &Cursor`tCtrl+F5", "DebugRunToCursor", IconLib, 96)
Menu AutoRunMenu, Add
AddMenu("AutoRunMenu", "Toggle Breakpoint`tF4", "ToggleBreakpoint", IconLib, 112)
AddMenu("AutoRunMenu", "Delete All Breakpoints", "DeleteBreakpoints", IconLib, 113)
Menu AutoRunMenu, Add
AddMenu("AutoRunMenu", "Variables", "ShowVarList", IconLib, 115)
AddMenu("AutoRunMenu", "Call Stack", "ShowCallStack", IconLib, 123)
AddMenu("AutoRunMenu", "Error Stream", "ShowStderr", IconLib, 124)
Menu AutoRunMenu, Add
