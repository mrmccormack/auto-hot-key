...
Gui Add, CheckBox, vChkSingleMatch x22 y194 w160 h23 +Checked, &One match per file
...
Gui Add, ListView, hWndhLVSearchResults vLV gLVHandler x8 y235 w%w% h%h% +LV0x14000 -Multi, Filename|Size|Date
LV_ModifyCol(1, 455)
LV_ModifyCol(2, 70)
...
SaveSettings() {
    ...
    IniWrite % Pos.showCmd, %IniFile%, Position, Show
...
MenuHandler:
    ...
    If (Item == 1) { ; Current directory
        ...
        If (Includes != "") {
            GuiControl Text, Directory, %Includes%
        }
    } Else { ; All open files
